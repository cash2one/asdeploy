...
SECRET_KEY = 'r95r15+6z2fl*s05bb-&amp;lte1x$nr4pifu$m3o2-blv^455e$_3'
...
ROOT_URLCONF = 'asdeploy.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'asdeploy.wsgi.application'

TEMPLATE_DIRS = (
    os.path.join(os.path.dirname(__file__), '../deployment/templates')
